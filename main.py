...
from libs import global_var,ap,ntptime
import gc
...
def WIFI_Connect():
    ...
    if not wlan.isconnected():
        ...
        print(info)
        d.fill(0)
        d.text('Connecting...', 10, 40)
        d.text(info['SSID'], 10, 56)
        d.text('Press KEY 5s RESET!', 10, 72)
        d.show()
...
#获取城市名称和编码
d.fill(0)
d.text('Getting...', 10, 48)
d.text('City Data', 10, 64)
d.show()
city_get()
